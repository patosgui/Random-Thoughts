...
title = "Transformers"
date = "2024-04-29"
description = "Implementing transformers from scratch"
tags = [
    "markdown",
    "css",
    "html",
...
The transformer architecture allows to perform tasks on inputs of variable length. This provides a
solution to the scalability of fully connected neural networks where processing hundreds or thousands of words
becomes unfeasable. 
